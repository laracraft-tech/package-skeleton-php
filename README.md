...
[![Check & fix styling](https://github.com/:vendor_slug/:package_slug/workflows/fix-php-code-style-issues.yml/badge.svg?branch=main)](https://github.com/:vendor_slug/:package_slug/actions/workflows/fix-php-code-style-issues.yml)
